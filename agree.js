function agreement {
		alert('Соглашение на обработку персональных данных 

Присоединяясь к настоящему Соглашению и оставляя свои данные на Сервисе, (далее – Сайт), путем заполнения полей онлайн-заявки (регистрации) Пользователь: 
...
Пользователь, предоставляет сервису Pandora право осуществлять следующие действия (операции) с персональными данными:
...
Отзыв согласия на обработку персональных данных может быть осуществлен путем направления Пользователем соответствующего распоряжения в простой письменной форме на адрес электронной почты (E-mail) info@pandora.com.
...
Действующая редакция всегда находится на странице по адресу: pandora.com/agreement
...
Сбор данных о Пользователе из системы facebook.com, vk.com

Регистрация Пользователя в системе Pandora может осуществляться через социальный сервис facebook.com, vk.com. Данный способ регистрации избирает сам Пользователь путем совершения указанных на Сайте действий в момент регистрации.
